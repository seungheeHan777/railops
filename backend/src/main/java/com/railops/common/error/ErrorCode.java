...
public enum ErrorCode {
    ...
    DUPLICATE_TRAIN_NO(HttpStatus.CONFLICT, "DUPLICATE_TRAIN_NO", "이미 사용 중인 열차 번호입니다."),
    CAR_NOT_FOUND(HttpStatus.NOT_FOUND, "CAR_NOT_FOUND", "객차 정보를 찾을 수 없습니다."),
    DUPLICATE_CAR_NO(HttpStatus.CONFLICT, "DUPLICATE_CAR_NO", "이미 사용 중인 객차 번호입니다."),
    DUPLICATE_SEAT_NO(HttpStatus.CONFLICT, "DUPLICATE_SEAT_NO", "이미 사용 중인 좌석 번호입니다."),
